...
__export(index_exports, {
  AUTHOR: () => AUTHOR,
  CustomFormEx: () => CustomFormEx,
  FormClose: () => FormClose,
  LICENSE: () => LICENSE,
  NAME: () => NAME,
  SimpleFormAsync: () => SimpleFormAsync,
  SimpleFormEx: () => SimpleFormEx,
  SimpleFormOperational: () => SimpleFormOperational,
  VERSION: () => VERSION,
  buildCustomForm: () => buildCustomForm,
  deepClone: () => deepClone,
  formatError: () => formatError,
  sendFormAsync: () => sendFormAsync,
  sendModalFormAsync: () => sendModalFormAsync,
  wrapAsyncFunc: () => wrapAsyncFunc
});
