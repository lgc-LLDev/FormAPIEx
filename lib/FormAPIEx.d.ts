 ...
 * @returns 构建好的表单
 */
declare function buildCustomForm(
  formTitle: string,
  objects: CustomFormObject[],
): CustomForm
type CustomFormObjectReturnType<T extends CustomFormObject> =
 ...
 * @returns 玩家选择的按钮
 */
declare function sendModalFormAsync(
  player: Player,
  title: string,
  content: string,
 ...
 */
declare function wrapAsyncFunc<T extends unknown[]>(
 ...
 * @returns 返回结果
 */
declare function sendFormAsync(
  player: Player,
  form: SimpleForm,
...
export {
  ...
  CustomFormEx,
  CustomFormInputObject,
  CustomFormInputOptions,
  CustomFormLabelObject,
  CustomFormObject,
  CustomFormObjectReturnType,
  CustomFormReturn,
  CustomFormSliderObject,
  CustomFormSliderOptions,
  CustomFormStepSliderObject,
  CustomFormSwitchObject,
  FormClose,
  LICENSE,
